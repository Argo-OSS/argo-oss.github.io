...
[Go to see Contributions Summary](#contribute-info)

## ☑️ Who We Are

The `ArgoWorkflows OSS 2023`team have 18 member. (1 Mentor, 17 Mentees)

Our Team met for participant to [Open Source Contribution Academy](https://www.contribution.ac/2023-ossca).
...
To become a graduated project, it must pass all tests conducted by the CNCF to meet their rigorous standards.
...
Since the rigorous standards, **only about 13% of projects** registered with the CNCF succeed in graduating.
...
Also, Argo Workflows can perform a various of tasks such as CI/CD as well as data pipelines because it runs each workflow step as an independent container.
This is possible due to use the power of Container and Kubernetes, than it can run **anything without restrictions.**
...
- [Search by name for WorkflowTemplates in UI](https://github.com/argoproj/argo-workflows/pull/11684)
- [show history about completed runs in each cron workflow](https://github.com/argoproj/argo-workflows/pull/11811)
- [Improvements to DataPciker](https://github.com/argoproj/argo-workflows/pull/11480)
- [UI toolbar sticky](https://github.com/argoproj/argo-workflows/pull/11444)
...
As contributions accumulate, our understanding of the project increased and we got more confidence.
We were increasingly able to contribute not only UI/UX improvements, but also **the core functionality of the workflow engine.**

[What’s new in Argo Workflows v3.5](https://blog.argoproj.io/whats-new-in-argo-workflows-v3-5-f260e8603ca6)

The core logic of the workflow engine is **install as a CRD in Kubernetes and has a significant impact on the behavior and performance of a Kubernetes cluster.**
So, Contributing to workflow engine is **quite difficult**.
...
Our team was very fortunate that the Argo Workflows project got a new leader in May of this year, [Yuan Tang](https://www.linkedin.com/in/terrytangyuan), and the breath of contributions across the project really accelerated.

Normally, in a large project like this, it would take quite a long time for reviews making it difficult to a lot of contributions.
...
<ContributeInfo contributers={['GeunSam2', 'qudtjs0753', 'umi0410', 'newdeal123', 'binkoni', 'Leeeuijooo', 'sudosubin', 'junkmm', 'shmruin', 'da-head0', 'synoti21', 'Jack-R-lantern', 'Yaminyam', 'zel0rd', 'yunwoo-yu', 'juijeong8324', 'moonyoungCHAE', 'sunyeongchoi']} />
...
| ![chart1](./images/common/chart1.png) |
| :-----------------------------------: |
| _Summary of contribution activities_  |
...
| ![chart2](./images/common/chart2.png) |
| :-----------------------------------: |
|       _Monthly Activity Graph_        |
...
> Repository address: https://github.com/ArgoWorkflows-OSS/argoworkflows-oss.github.io

> Goal: Update member profile of issue template Select issue and create first PR according to issue content.

![activity1](./images/common/activity1.png)
...
> Page address: https://github.com/ArgoWorkflows-OSS/container-playground

> Goal: Create your own service and configure CI for containerization

![activity2](./images/common/activity2.png)

![activity3](./images/common/activity3.png)
...
![activity4](./images/common/activity4.png)

![activity5](./images/common/activity5.png)

### Join to Contributor / Community meetings

![activity6](./images/common/activity6.png)

### Argo Workflows OSS team page creation and operation

> Page address: https://argoworkflows-oss.github.io/

> Production framework: nextra

![activity7](./images/common/activity7.png)
...
- Detailed information about offline regular meetings can be found through the link [here](https://argoworkflows-oss.github.io/).

![activity8](./images/common/activity8.png)
...
- Topic of interest presentation topic and presenter
  | order | Title | Presenter | Announcement date |
  | :----: | ----------------------------------------------------------------------------- | :--------: | :------------------: |
  | 1 | Case study of Argo Workflows adoption at Carrot Market | Yeom Geun-cheol | July 15 |
  | 2 | WebRtc concept and use cases for real-time communication | Song Hye-min | July 30 |
  | 3 | How to link Argo Workflows and Keyclock | Soon yeong-Choi | July 30 |
  | 4 | Implementing CI/CD with Argo Project | Hak jun-Kim | August 6 |
  | 5 | Presentation of eBPF concept, filter development method, and use cases | Seong rak-Jeong | August 6 |
  | 6 | History of containers and creating containers without Docker | Yeom Geun-cheol | August 13 |
  | 7 | Platform builder that allows developers to load test themselves & K6 load test PoC announcement | Ah Da-hye | August 20 |
  | 8 | Considerations on the container ecosystem | Yeom Geun-cheol | August 27 |
  | 9 | Github Actions Installing and operating self-hosted in Kubernetes | Cheong woon-Seo | September 2nd |

![activity9](./images/common/activity9.png)
...
![activity10](./images/common/activity10.png)
...
<ContributeInfo contributers={['qudtjs0753']} />

### 2. [SiOn Kang](https://www.linkedin.com/in/sion-kang-3146551bb/)
...
I enjoyed last year's experience so much that I decided to participate again this year, but this year was a great experience again with a different feel from last year.
...
<ContributeInfo contributers={['Yaminyam']} />
...
<ContributeInfo contributers={['zel0rd']} />

### 4. [SuBin Kim](https://www.linkedin.com/in/sudosubin)
...
<ContributeInfo contributers={['sudosubin']} />
...
<ContributeInfo contributers={['junkmm']} />

### 6. [JinSu Park](https://www.linkedin.com/in/jinsu-park-dev/)
...
<ContributeInfo contributers={['umi0410']} />
...
<ContributeInfo contributers={['newdeal123']} />

### 8. [HaeMin Song](www.linkedin.com/in/haemin-song-771626120)
...
<ContributeInfo contributers={['shmruin']} />

### 9. [DaHae Ahn](https://www.linkedin.com/in/dahye-ahn-223244234/)
...
`Document modification` The [running-locally](https://argoproj.github.io/argo-workflows/running-locally/) part of the official document is not intuitive for people who are new to Dev-container and Makefile, and is broken.
There were links, so I uploaded pr [#11405](https://github.com/argoproj/argo-workflows/pull/11405) and contributed to editing the official document.

`Issue Contribution` Although `incomplete`, this is an issue where secret information can be exposed through commands such as echo within Argo-workflows workflows or Pods within workflows [#8685](https://github.com/argoproj/ argo-workflows/issues/8685), so I tried to solve it.

I invested about 3 hours a day for 4 days, for a total of 12 hours, on this issue, but I have not yet been able to resolve it. ([Intermediate commit](https://github.com/argoproj/argo-workflows/commit/35866a599de80c02a950c52e800e69fc894d5b80))
...
- We added `ARGO_HIDE_SECRETS`, an environment variable that can be injected when running Argo-workflows, across a total of 11 files, and set the option to `true` by default.
  ...
  - If information corresponding to Secret is included in the workflow or pod log, the code has been modified to mask SecretValue.
    ...
    - However, since the above function did not work as intended, I started exploring the process of recording logs. I found out that the [logrus](https://github.com/sirupsen/logrus) library used in the Go language uses io.Writer from the [io](https://pkg.go.dev/io) package. .
...
- In order to upload pr from the actual Argo-workflows repo, modify the code and check whether Argo-workflows is working properly, you must run Argo-workflows with a Dev Container in the local environment.
  -Our team was given the task of carrying out this process ourselves, and along the way, we helped each other with members who had difficulty performing it. I summarized how to perform the method in a blog post and shared it with my team members.[blog](https://aimb.tistory.com/317)
...
<ContributeInfo contributers={['da-head0']} />
...
For the first time, I made a documented contribution to ArgoWorkflows. We've fixed the parts on the official site where there's room to confuse whether it's an image or a video, so that users know it's definitely a video.
...
I didn't notice when I was using argo workflow, but I realized that it was possible to contribute to places that could pass by by catching that page-nation is inconsistent and making issues.
...
I found out that when you solve dependency issues and later someone else makes an issue on my project, you use development containers to ensure you're working in the same environment,
and I thought I'd have to use development containers in other projects I'm working on (discord bot-related projects).

After the interim report, rather than changing my mind a little and feeling intimidated, I wanted to take the opportunity to overhear how other current employees operate the service in practice.
In fact, mentees presented various topics, and I was able to hear interesting topics such as load tests and explanations about ebpf in the company. I think it was a very valuable presentation that was hard to hear while attending school.

---

**4. Mastering the Verified Commit method using GPG Sign and uploading the introduction to Team GitHub**

Until now, I've been committing without a separate GPG Key, but in the process of uploading the member introduction, I checked the DCObot and GPG and kept getting blocked,
so I learned how to create a Verified commit and uploaded the introduction to Team GitHub Repo. In the process, I solved it with the help of the same team member while constantly stopping whenever I committed.
...
I saw a lot of issues in Argo Workflow and looked for it to contribute to anything, but I couldn't touch it because it was so complicated and I didn't know the Go language.
...
Another person's most memorable contribution was "Page Nation." I was impressed to see that some parts of Argo Workflow are page-nations, some parts are not,
...
As everyone else, including you, is an incumbent and is very talented, I learned a lot from going to the meeting.
...
To be honest, as I participated in open-source competition, I also have a desire to contribute at least one issue.
...
<ContributeInfo contributers={['synoti21']} />

### 11. [YoonWoo You](https://www.linkedin.com/in/yunwoo-yu-65095b263/)
...
<ContributeInfo contributers={['yunwoo-yu']} />
...
It was great to be motivated not only to contribute to open source but also to learn about new technologies through this Contribution Academy.
...
<ContributeInfo contributers={['binkoni']} />

### 13. [EuiJu Lee](https://www.linkedin.com/in/euijoolee3233)
...
<ContributeInfo contributers={['Leeeuijooo']} />

### 14. [EuiJung Geon](https://www.linkedin.com/in/jeon01/)
...
[Series | 2023 OSSCA - ddubi.log](https://velog.io/@juijeong8324/series/2023-OSSCA)
...
1. **The task regarding issue/commit/PR in Github**
   ...
   **[Outcome]**
   ...
   [docs : update UiJeong Profile by juijeong8324 · Pull Request #19 · ArgoWorkflows-OSS/ArgoWorkflows-OSS](https://github.com/ArgoWorkflows-OSS/ArgoWorkflows-OSS/pull/19)

   [records: Github에서 issue/commit/PR](https://velog.io/@juijeong8324/OSSCA-2023-2)
...
2. **Running Locally**
   ...
   **[Outcome]**
   ...
   [records: Argo Workflows running locally](https://velog.io/@juijeong8324/OSSCA-2023-3)

   [records: Argo Workflows running locally - retry](https://velog.io/@juijeong8324/OSSCA-2023-4)

   [records: Argo Workflows running locally - final](https://velog.io/@juijeong8324/OSSCA-2023-5)

   [records: Argo Workflows running locally - real final](https://velog.io/@juijeong8324/OSSCA-2023-6)

<br />

3. **Special class for Beginners - Create my own service container image**
   ...
   **[Outcome]**
   ...
   [code: About task](https://github.com/ArgoWorkflows-OSS/container-playground/tree/main/juijeong8324)

   [records: 왕초보 특별반 - 1. 나만의 서비스 컨테이너 이미지 제작](https://velog.io/@juijeong8324/OSSCA-2023-7)

   [records: [Docker] Dockerfile 기본 명령어에 대해 알아보자](https://velog.io/@juijeong8324/Docker-dockerfile)
...
| Date | Activity |
| :--- | :--- |
| 2023.07.15 | - Introduction team <br /> - (Seminar) Introduction to Argo workflows and mentor’s application examples |
|2023.07.30|- Searching and sharing issues of the week <br /> - I was solving a local running problem. <br /> - (Seminar) HaeMin's WebRtc, Sunyeong's keyclock and argo worfklows |
|2023.08.13|- Receive feedback on Special class of beginners assignment <br /> - Searching and sharing issues of the week <br /> - (Seminar) Mentor’s special lecture on history and principles|
|2023.08.20|- Searching and sharing issues of the week <br /> - I share `Issue #11131`` <br /> - (Seminar) DaHae's ‘Platform builder & K6 execution test PoC that allows developers to perform execution tests on their own’|
...
- [**Issue #11131**](https://github.com/argoproj/argo-workflows/issues/11131) `Fix Bug`

  **[Summary]**

  Error occurs when `"` in a workflow input parameter fails to escape and is referenced as `workflow.parameter.json`

  **[Outcome]**

  I dissmiss this issue because of the eeror occured from python environment not argo workflows.

  [records: Argo Workflows - Issue #11131](https://velog.io/@juijeong8324/Argo-Issue11131)

<br />

- [**Issue #11706**](https://github.com/argoproj/argo-workflows/issues/11706) `Improve UI`
  ...
  **[Summary]**
  ...
  [records: Argo Workflows - Issue #11706 (인생 처음으로 올린 감격적인 나의 소중한 Issue)](https://velog.io/@juijeong8324/OSSCA-2023-11)
...
- [**PR #11732**](https://github.com/argoproj/argo-workflows/pull/11732) `docs` `PR Merge`
  ...
  **[Outcome]**
  ...
  [records: Argo Workflows - PR #11732 docs: Add description about img in artifact-visualization.md](https://velog.io/@juijeong8324/OSSCA-2023-13)
...
- [**PR #11811**](https://github.com/argoproj/argo-workflows/pull/11811) `Improve UI` `PR Merge`

  **[PR Summary]**

  The PR tries to solve [Issue #11706](https://github.com/argoproj/argo-workflows/issues/11706)
...
<ContributeInfo contributers={['juijeong8324']} />
...
2. **feat: logging for client-side throttling**

   **issue**: [#11387](https://github.com/argoproj/argo-workflows/issues/11387), [#11402](https://github.com/argoproj/argo-workflows/issues/11402) \
...
3. **go 1.21 upgrade**
   ...
   **issue**: [#11566](https://github.com/argoproj/argo-workflows/issues/11556) \
    **pr**: [#11601](https://github.com/argoproj/argo-workflows/pull/11601) \
   ...
   ![issue-report1](./images/Jack-R-lantern/issue-report1.jpg)
   ...
   ![issue-report2](./images/Jack-R-lantern/issue-report2.jpg)
   ...
   ![issue-report3](./images/Jack-R-lantern/issue-report3.jpg)
...
4. **Debugging 설정**
   ...
   **detail:** \
   ...
   ![debug-1](./images/Jack-R-lantern/debug1.jpg)
...
<ContributeInfo contributers={['Jack-R-lantern']} />
...
I wanted to contribute to a large open source community, but I felt at a loss. It was great to be able to contribute directly through this academy.
...
<ContributeInfo contributers={['moonyoungCHAE']} />

### 17. [SooNyeong Choi](https://www.linkedin.com/in/sunyeongchoi/)
...
<ContributeInfo contributers={['sunyeongchoi']} />
