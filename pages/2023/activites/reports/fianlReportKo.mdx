...
대형 오픈소스 커뮤니티에 기여하고 싶었으나, 막막함이 컸다. 이번 아카데미를 통해 직접 기여할 수 있어 좋았다. 기여 경험이 많은 멘티님이 기여할 수 있도록 단계별로 안내해주고, 도전할 수 있게끔 유도해주어서 가능했다. 다른 개발자와 기술 세미나를 하고 기술 교류를 하며, 상호 성장할 수 있었다. ArgoWorkflow는 큰 규모의 프로젝트이기 때문에 혼자 분석하면 어려운 부분이 많은데, 다른 개발자와 의견을 나누어 좀 더 빠르게 문제를 해결할 수 있었다. ArgoWorkflow 프로젝트를 어느 정도 이해했고, 작은 컨트리뷰트 경험을 통해 자신감이 생겼기 때문에 다음 기여는 더 쉽게 할 수 있으리라 기대된다. 이번 프로그램이 끝난 후에도 ArgoWorkflow에 관심이 많은 다른 멘티들과 서로 협업하며 더 큰 규모의 기여를 할 계획이다.
