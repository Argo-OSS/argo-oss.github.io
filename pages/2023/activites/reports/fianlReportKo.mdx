...
1. **Github에서 issue/commit/PR 미션 수행**
   ...
   **[과제 요약]**
   ...
   ![mission1](./images/UiJeongJeon/mission1.png)
...
- [Issue #11706](https://github.com/argoproj/argo-workflows/issues/11706) `기능개선`
